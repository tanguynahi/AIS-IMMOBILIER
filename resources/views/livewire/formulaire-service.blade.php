            ...
            <div class="row pad-20">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="form-group propertytitle">
                        ...
                        <input type="text" placeholder="Designation du service"
                        class="form-control @error('libservice') is-invalid @enderror" wire:model="libservice">
                        @error('libservice') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 mb-10">
                    <label class="form-label">Image service</label>
                    <input type="file" id="{{ $imgID }}" accept=".jpg, .png, .jpeg, .avif"
                ...
                <div class="row pad-20">
                    <div class="col-12">
                        <button class="btn btn-primary" wire:click="saveService">
