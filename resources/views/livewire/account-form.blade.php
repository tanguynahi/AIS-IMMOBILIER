                ...
                <div class="row g-4 mb-0">
                    <div class="col-sm-auto">
                        <div>
                            ...
                            {{-- <a id="btnNouveauCompte" class="btn btn-outline-primary" style="margin-left: 20px">
                            <i class="fa fa-plus"></i>&nbsp;&nbsp;Nouveau compte
                        </a> --}}
                            <button type="button" class="btn btn-outline-primary" style="margin-left: 20px"
                                wire:click="changeFormCompteur">
                                <i class="fa fa-plus"></i>&nbsp;&nbsp;Nouveau compte
                            </button>
                        ...
                        <div class="col-lg-3 col-md-3" @if (!empty($idus)) hidden @endif>
                            <div class="form-group motdepasse">
                                ...
                                <input type="password" class="form-control" autocomplete="off"
                                    placeholder="Mot de passe" id="MotDePasse" wire:model="motdepasse"
                ...
                <div class="row">
                    @foreach ($roles as $key => $value)
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4">
                            <div class="checkbox checkbox-theme checkbox-circle">
                                <input id="{{ $value->CODE_ACCES }}" type="checkbox"
                                    wire:model="{{ $value->CODE_ACCES }}">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                        ...
                        <button class="btn btn-outline-secondary" type="button" wire:click="Annuelle">
    ...
    {{-- @push('js')
        ...
        <script>
            $(document).ready(function() {
                $("#btnNouveauCompte").on("click", function() {
                    $("#customerList").hide();
                    $("#formCompte").show();
                });
