        ...
        <div class="listjs-table" id="customerList">
            <div class="col-lg-12 row mb-0">
                ...
                <div class="col-lg-8 mb-10">
                    <div class="form-group">
                        <label>Client </label>
                        <select class="form-control" wire:model.live="idclient" wire:change="getaffaireclient">
                            <option value="0">Tous..</option>
                            @foreach ($clients as $c)
                                <option value="{{$c->ID_CLIENT}}">
                                    {{$c->NOM ?? 'xxxx'}} {{$c->PRENOMS ?? 'xxxx'}} ({{$c->CONTACT?? 'xxxx'}})
                                </option>
                            @endforeach
                        </select>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <div class="buttons">
                                        <a href="{{route('paiemForm', ['idPaiement'=>$value->ID_PAIEMENTS])}}"
