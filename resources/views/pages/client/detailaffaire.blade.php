...
@section('content')
    @include('partials.client.breadcrumb-navcli', ['LBL' => 'Affaire conclue'])
    <div class="submit-address dashboard-list">
        <br />
        <a type="button" onclick="cancel();" class="mb-10" style="margin-left: 20px">
            <i class="fa fa-angle-double-left"></i>&nbsp;<b>Retour</b>
        </a>
        <h4> Detail affaire n°{{$affaire->ID_AFFAIRES ?? 'xxxxxx'}} </h4>
        <div class="row pad-20">
            <div class="col-lg-6 row">
                <h6><u>Informations sur le biens</u></h6>
                <div class="comment">
                    <div class="col-lg-6 mb-20">
                        <img src="{{asset($affaire->IMG_DEFAULT ?? 'img/avatar/avatar-1.png')}}" style="height: 100%; width: 100%">
                    </div>
                    <div class="col-lg-12">
