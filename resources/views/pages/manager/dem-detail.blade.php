        ...
        <div class="row pad-20">
            ...
            <div class="col-lg-12 row mb-10">
                ...
                <div class="col-lg-12 mb-10">
                    <span>Assistance : <b class="text-danger">{{ $demande->ASSISTANCE ?? 'Aucune assistance' }}</b></span>
                </div>
            </div>
            ...
            <div id="modChps" style="display: none">
                ...
                <br />
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-12 mb-20"
                        @if ($demande->TYPE_DEMAND != 1) style="display: none;" @endif id="dt">
                        <div class="form-group">
                            <label for="date" class="form-label">Date visite *</label>
                            <input type="date" class="form-control" id="date"
                                value="{{ $demande->DATE_VISIT ?? '' }}">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-12 mb-20"
                        @if ($demande->TYPE_DEMAND != 1) style="display: none;" @endif id="hr">
                        <div class="form-group">
                            <label for="date" class="form-label">Heure visite</label>
                            <input type="time" class="form-control" id="heure"
                                value="{{ $demande->HEUR_VISIT ?? '' }}">
                        </div>
                    </div>
                            ...
                            <select class="form-control" id="propriete">
                                ...
                                @foreach ($proprietes as $p)
                                    <option value="{{ $p->ID_PROPRIETES }}"
                                        @if ($p->ID_PROPRIETES == $demande->ID_PROPRIETES) selected @endif>
                                        ({{ $p->LIB_TYPE }})
                                        {{ $p->LIB_PROPRIETE }} | {{ $p->LIB_CATEGORIE }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 mb-20">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="typeD">
                                ...
                                <option value="1" @if ($demande->TYPE_DEMAND == 1) selected @endif>Visite de
                                    propriété</option>
                                <option value="2" @if ($demande->TYPE_DEMAND == 2) selected @endif>Information par
                                    appel</option>
                                <option value="3" @if ($demande->TYPE_DEMAND == 3) selected @endif>Information par
                                    email</option>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 mb-20"
                        @if ($demande->STATUT != Help::$REFUSE) style="display: none;" @endif>
                        <div class="form-group message">
                            <label for="motif" class="form-label">Motifs de rejet</label>
                            <textarea class="form-control" id="editmotifrej" rows="3" placeholder="Saisi ici le motif du rejet...">{{ $demande->MOTIFS ?? '' }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="buttons mb-20">
                        <a class="btn-1 btn-gray" type="button"
                            onclick="actionBars('vad',{{ $demande->ID_DEMANDE_VISIT }});">
            ...
            <div id="motifChps" style="display: none">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 mb-20">
                    <div class="form-group message">
                        <label for="motif" class="form-label">Motifs de rejet</label>
                        <textarea class="form-control" id="motif" rows="3" placeholder="Saisi ici le motif du rejet..."></textarea>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="buttons mb-20">
                        <a class="btn-1 btn-gray" type="button"
                            onclick="actionBars('val',{{ $demande->ID_DEMANDE_VISIT }});">
                            <i class="fa fa-fw fa-check-circle-o"></i>Valider
                        </a>
                        &nbsp;&nbsp;
                        <a class="btn-1 btn-gray" type="button" onclick="actionBars('ini', '0');">
                ...
                <div class="col-lg-12">
                    <div class="buttons mb-20">
                        @if ($demande->STATUT != Help::$ACTIF)
                            ...
                            &nbsp;&nbsp;
                            <a class="btn-1 btn-gray" type="button"
                                onclick="actionBars('sav', {{ $demande->ID_DEMANDE_VISIT }});">
                    ...
                    if (confirm("Voulez-vous rejeter cette demande ?")) {
                        ...
                        if (motif == '' || motif.length < 10) {
                            ...
                            $.ajax({
                                ...
                                error: function(res) {
                                    console.log(res);
                                    alert('alert: Erreur interne du serveur !');
                                }
                            });
                        }
                    }
