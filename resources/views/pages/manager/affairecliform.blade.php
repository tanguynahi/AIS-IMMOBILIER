...
@section('content')
    @include('partials.manager.breadcrumb-nav', ['LBL' => 'Fiche d\'Acquisition de bien'])
                ...
                <div class="row pad-20">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="form-group">
                            <label>Client *</label>
                            <select class="form-control" id="client" disabled>
                                <option value="0" selected disabled>Choisir client..</option>
                                @foreach ($clients as $c)
                                    <option value="{{$c->ID_CLIENT}}" @if($idCli==$c->ID_CLIENT) selected @endif>
                                        {{$c->NOM}} {{$c->PRENOMS}} ({{$c->CONTACT}})
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <div class="form-group">
                            <label for="date" class="form-label">Date acquisiton</label>
...
@section('js')
    ...
    <script>
        ...
        function cancel() {
            idC = document.getElementById("client").value;
            rout = "{{route('clientForm',['idClient'=>':idClient'])}}";
            rout = rout.replace(':idClient', idC);
