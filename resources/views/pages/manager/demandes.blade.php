...
@section('content')
    @include('partials.manager.breadcrumb-nav', ['LBL' => 'Demandes'])
    <div class="submit-address dashboard-list">
        <h4>Liste des demandes de Visite</h4>
        <div class="row">
            <div class="col-lg-12">
                <div class="">
                    <div class="card-body">
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            ...
                                            <td class="name">{{ $value->LIB_CLIENT ?? 'xxxxxx' }}</td>
                                            ...
                                            <td class="phone" title="{{$value->MESSAGE ?? ''}}">
                                                {{ Help::strCut($value->MESSAGE ?? 'Aucun texte', 0, 32, '...') }}
                                            </td>
                                            <td class="status">
                                                @switch($value->STATUT)
                                                    @case(Help::$ENATTENTE)
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="buttons">
                                                        <a href="{{route('demandeForm',['idDemand'=>$value->ID_DEMANDE_VISIT])}}"
