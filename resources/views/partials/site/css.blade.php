...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/boxes-component.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/boxes-core.css') }}">
...
<link rel="stylesheet" type="text/css" id="style_sheet" href="{{ asset('assets/css/skins/blue.css') }}">
...
<style>
    :root,
    [data-bs-theme=light] {
        --vz-primary-bg-subtle: #e9e7fd;
        --vz-secondary-bg-subtle: #e6effe;
        --vz-success-bg-subtle: #dbf8f4;
        --vz-info-bg-subtle: #eafafc;
        --vz-warning-bg-subtle: #fff6e7;
        --vz-danger-bg-subtle: #ffece3;
