 ...
 *   https://datatables.net/download/#dt/dt-2.0.6/b-3.0.2/b-print-3.0.2/fh-4.0.1/sp-2.3.1
 *
 * Included libraries:
 *   DataTables 2.0.6, Buttons 3.0.2, Print view 3.0.2, FixedHeader 4.0.1, SearchPanes 2.3.1
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.0.6/b-3.0.2/b-print-3.0.2/fh-4.0.1/sp-2.3.1",
