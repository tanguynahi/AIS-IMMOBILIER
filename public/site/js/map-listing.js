(function ($) {
    ...
    var markerIcon = {
        ...
        url: '../site/images/marker-single.png',
    }
    function mainMap() {
        function locationData(locationURL, locationCategory, locationImg, locationTitle, locationAddress,     locationPrice , locationStatus) {
		 ...
		 //   locations ------------------
        var locations = [
            [locationData('listing-single2.html', 'Apartment', 'site/images/all/3.jpg', 'Gorgeous house for sale', "70 Bright St New York, USA",  "600.000" , "Sale"), 40.72956781, -73.99726866, 0, markerIcon],
            [locationData('listing-single.html', 'Apartment', 'site/images/all/1.jpg', 'Luxury Family Home', "40 Journal Square  , NJ, USA",  "320.000" , "Sale"), 40.76221766, -73.96511769, 1, markerIcon],
            [locationData('listing-single.html', 'House', 'site/images/all/9.jpg', 'Family house for Rent', "34-42 Montgomery St , NY, USA",    "700 / per month" , "Rent"), 40.88496706, -73.88191222, 2, markerIcon],
            [locationData('listing-single.html', 'House', 'site/images/all/6.jpg', 'Contemporary Apartment', "W 85th St, New York, USA",   "1,600.000" , "Sale"), 40.72228267, -73.99246214, 3, markerIcon],
            [locationData('listing-single.html', 'Villa', 'site/images/all/5.jpg', 'Kayak Point House', "75 Prince St, NY, USA",   "500.000" , "Sale"), 40.94982541, -73.84357452, 4, markerIcon],
            [locationData('listing-single.html', 'Apartment', 'site/images/all/8.jpg', ' Urban House', "70 Bright St, Jersey City, NJ USA",   "1500 / per month" , "Rent"), 40.90261483, -74.15737152, 5, markerIcon],
            [locationData('listing-single.html', 'Apartment', 'site/images/all/4.jpg', 'Park Avenue apartment', "123 School St. Lynchburg, NY ",   "1000 / per month" , "Rent"), 40.79145927, -74.08252716, 6, markerIcon],
            [locationData('listing-single2.html', 'Hotel', 'site/images/all/25.jpg', 'Fancy Hotel', "Mt Carmel Pl, New York, NY",     "1.200.000" , "Sale"), 40.58423508, -73.96099091, 7, markerIcon],
            [locationData('listing-single2.html', 'Office', 'site/images/all/7.jpg', 'New York Office Center', "1-30 Hunters Point Ave, Long Island City, NY",     "510 / per month" , "Rent"), 40.58110616, -73.97678375, 8, markerIcon],
            [locationData('listing-single3.html', 'Hotel', 'site/images/all/27.jpg', 'Apartment to rent in Queens', "726-1728 2nd Ave, New York, NY", "1800 / per month" , "Rent"), 40.73112881, -74.07897948, 9, markerIcon],
            [locationData('listing-single3.html', 'Office', 'site/images/all/3.jpg', 'Beautiful Flat in Manhattan', "9443 Fairview Ave, North Bergen, NJ",   "800.000" , "Sale"), 40.67386831, -74.10438536, 10, markerIcon],
        ];
	    //   Map Infoboxes end ------------------
